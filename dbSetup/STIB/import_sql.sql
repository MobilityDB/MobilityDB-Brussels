...
DECLARE
	...
	feed_idx INTEGER;
BEGIN
	FOREACH tablename IN ARRAY ARRAY['stop_times', 'trips', 'routes', 'calendar_dates', 'calendar', 'shapes', 'stops', 'agency'] LOOP
		BEGIN
...
--select gtfs_static_load('/mnt/c/Users/Wassim/Desktop/Memo \BM/GTFS \STIB/gtfs23/');
